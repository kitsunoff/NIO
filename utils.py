...
def get_workdir_path(namespace: str, name: str, repo_name: str, commit_hash: str) -> str:
...
async def clone_git_repo(git_url: str, credentials_ref: Optional[Dict] = None, 
                       namespace: str = "default", target_path: Optional[str] = None) -> Tuple[str, str]:
...
async def get_remote_commit_hash(git_url: str, ref: str, credentials_ref: Optional[Dict] = None, 
