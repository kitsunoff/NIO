...
type NixosConfigurationSpec struct {
	...
	// foo is an example field of NixosConfiguration. Edit nixosconfiguration_types.go to remove/update
	// +optional
...
type NixosConfigurationStatus struct {
	...
	// conditions represent the current state of the NixosConfiguration resource.
...
type NixosConfiguration struct {
	...
	// +optional
	Status NixosConfigurationStatus `json:"status,omitzero"`
}
